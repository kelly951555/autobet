...
try:
    ...
    # 两面盘-------------------------------
    play3d = driver.find_element_by_xpath("/html/body/div/div/div[2]/div[2]/ul/li[12]")
    play3d.click()
    # 一字
    play3d_1 = driver.find_element_by_xpath("/html/body/div/div/div[2]/div[3]/div/span[1]/span")
    play3d_1.click()
    play_n = play3d.text + play3d_1.text      
    for j in range(1,4):
        for c in range(1,7):
            driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[5]/div/div[1]/div[{}]/div[2]/ul/li[{}]'.format(j,c)).click()
    for j in range(1,3):
        for c in range(1,7):
            driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[5]/div/div[2]/div[{}]/div[2]/ul/li[{}]'.format(j,c)).click()
    for c in range(1,5):
        driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[5]/div/div[2]/div[3]/div[2]/ul/li[{}]'.format(c)).click()
    add_order.click()
    time.sleep(waittime(driver))
    # send_project(play_n)
    # 二字
    play3d_2 = driver.find_element_by_xpath("/html/body/div[1]/div/div[2]/div[3]/div/span[2]")
    play3d_2.click()
    play_n = play3d.text + play3d_2.text
    for n in range(1,20,2):
        for c in range(1,3):
            driver.find_element_by_xpath('/html/body/div/div/div[2]/div[5]/div/div[{}]/div[2]/ul/li[{}]'.format(n,c)).click()
    ...
    # send_project(play_n)
    # 三字
    play3d_3 = driver.find_element_by_xpath("/html/body/div[1]/div/div[2]/div[3]/div/span[3]")
    play3d_3.click()
    play_n = play3d.text + play3d_3.text      
    for n in range(1,7):
        for c in range(1,5):
            driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[5]/div[1]/div[{}]/div[2]/ul/li[{}]'.format(n,c)).click()
    add_order.click()
    time.sleep(waittime(driver))
    # send_project(play_n)
    # 龙虎和
    play3d_tg = driver.find_element_by_xpath("/html/body/div[1]/div/div[2]/div[3]/div/span[4]")
    play3d_tg.click()
    play_n = play3d.text + play3d_tg.text      
    for n in range(1,5):
        for c in range(1,4):
            driver.find_element_by_xpath('/html/body/div/div/div[2]/div[5]/div/div[1]/div[{}]/div[2]/ul/li[{}]'.format(n,c)).click()
    for k in range(2,4):
        for n in range(1,4):
            for c in range(1,4):
                driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[5]/div/div[{}]/div[{}]/div[2]/ul/li[{}]'.format(k,n,c)).click()
    add_order.click()
    time.sleep(waittime(driver))
    send_project(play_n)
